...
// //         <div class="container flex flex-wrap sm:flex-nowrap  justify-between items-center mx-auto ">
...
export const Nee = () => {
  ...
  return (
    <Navbar
      // fluid={true}
      // rounded={true}
      className="bg-white fixed px-2 sm:px-10 md:border-b-2 border-b-[0.4vh]  md:px-28 dark:bg-gray-900 w-full z-20 top-0 left-0  border-gray-200 dark:border-gray-600"
    >
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link href="/navbars" className="text-[#2978b5] md:text-md">
          Projects
        </Navbar.Link>
        <Navbar.Link href="/navbars" className="text-[#2978b5] md:text-md">
          Contact
